export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-[#25D366] pl-4 pr-5 py-3 shadow-[0_10px_40px_-10px_rgba(37,211,102,0.6)] hover:shadow-[0_14px_50px_-10px_rgba(37,211,102,0.8)] hover:-translate-y-0.5 transition-all"
    >
